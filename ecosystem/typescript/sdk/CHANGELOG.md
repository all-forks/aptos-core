...
- Added `CoinClient` to help working with coins. This contains common operations such as `transferCoins`, `checkBalance`, etc.
- Added `generateSendWaitForTransaction`, a function that provides a simple way to execute the full end to end transaction submission flow.
