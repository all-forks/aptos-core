...
export class AptosClient {
   ...
   * @returns
   */
  async generateSendWaitForTransaction(
    sender: AptosAccount,
...
/**
 * This error is used by `generateSendWaitForTransaction` when a transaction is
 * processed by the API, but it was not committed successfully.
 */
